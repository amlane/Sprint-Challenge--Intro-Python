...
def cityreader(cities=[]):
    ...
    with open("cities.csv") as citiesfile:
        line_counter = 0
        file_reader = csv.reader(citiesfile, delimiter=",")
...
cmd1 = input("Please enter [lon1, lat1]: ")
cmd2 = input("Please enter [lon2, lat2]: ")

float1 = float(cmd1.split(",")[0])
float2 = float(cmd1.split(",")[1])
...
print("++++++++++++++++++++++++++++++++++++++++++++++")
cityreader_stretch(float1, float2, float3, float4, cities)
